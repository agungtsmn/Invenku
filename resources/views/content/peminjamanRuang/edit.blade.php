...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Edit Pengajuan Peminjaman Ruang</h4>
      <p class="mg-b-0">Edit Form Pengajuan Peminjaman Ruang</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/peminjamanRuang/{{ $peminjamanRuang->id }}" method="post">
          @csrf
          @method('put')
          <div class="row no-gutters">
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <select class="form-control select2-show-search" name="pemohon" data-placeholder="Pilih Pegawai" required>
                  <option value="{{ $peminjamanRuang->pemohon }}">{{ $peminjamanRuang->fPemohon->nama }}</option>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1">
                ...
                <input class="form-control" type="text" name="substansi" placeholder="Enter Substansi" required value="{{ $peminjamanRuang->substansi }}">
                @error('substansi')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <select class="form-control select2-show-search" name="penanggung_jawab" data-placeholder="Pilih Penanggung Jawab" required>
                  <option value="{{ $peminjamanRuang->penanggung_jawab }}">{{ $peminjamanRuang->fPenanggungJawab->pegawai->nama }}</option>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <select class="form-control select2-show-search" name="verifikator" data-placeholder="Pilih Verifikator" required>
                  <option value="{{ $peminjamanRuang->verifikator }}">{{ $peminjamanRuang->fVerif->pegawai->nama }}</option>
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <select class="form-control select2-show-search" name="ruang_id" data-placeholder="Pilih Ruang" required>
                  <option value="{{ $peminjamanRuang->ruang_id }}">{{ $peminjamanRuang->ruang->nama }}</option>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <div class="mt-2 row">
                  <div class="col-md-3">
                    <label class="ckbox">
                      <input type="checkbox" name="alat_khusus[]" value="Audio" {{ in_array('Audio', json_decode($peminjamanRuang->alat_khusus ?? [], true)) ? 'checked' : '' }}>
                      <span>Audio</span>
                    </label>
                  </div>
                  <div class="col-md-3">
                    <label class="ckbox">
                      <input type="checkbox" name="alat_khusus[]" value="Zoom" {{ in_array('Zoom', json_decode($peminjamanRuang->alat_khusus ?? [], true)) ? 'checked' : '' }}>
                      <span>Zoom</span>
                    </label>
                  </div>
                  <div class="col-md-6">
                    ...
                    @endphp
                    <input class="form-control" type="text" name="alat_khusus[]" placeholder="Lainnya..." value="{{ $alatKhusus->last() }}">
                  </div>
                </div>
              </div>
            </div><!-- col-6 -->
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="datetime-local" name="tanggal_penggunaan" placeholder="Enter Tanggal Penggunaan" required value="{{ $peminjamanRuang->tanggal_penggunaan }}">
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <input class="form-control" type="datetime-local" name="tanggal_selesai" placeholder="Enter Tanggal Selesai" required value="{{ $peminjamanRuang->tanggal_selesai }}">
            ...
            <div class="col-md-12">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="text" name="keperluan" placeholder="Enter Keperluan" required value="{{ $peminjamanRuang->keperluan }}">
                @error('keperluan')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
