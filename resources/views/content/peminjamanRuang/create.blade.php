...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Pengajuan Peminjaman Ruang</h4>
      <p class="mg-b-0">Form Pengajuan Peminjaman Ruang</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/peminjamanRuang" method="post">
          @csrf
