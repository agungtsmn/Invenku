...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Create Peminjaman BMN</h4>
      <p class="mg-b-0">Adding peminjaman BMN to the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/manage/peminjamanBmn" method="post">
          @csrf
          <div class="row no-gutters">
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="number" name="lama_pinjam" placeholder="Enter Lama Pinjam" required value="{{ old('lama_pinjam') }}">
                @error('lama_pinjam')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <input class="form-control" type="text" name="lokasi_penggunaan" placeholder="Enter Lokasi Penggunaan" required value="{{ old('lokasi_penggunaan') }}">
              ...
              <div class="row no-gutters row-bmn"> <!-- Row BMN -->
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force">
                    ...
                    <input class="form-control" type="text" name="jenis[]" placeholder="Enter Jenis BMN" required>
                  </div>
                </div><!-- col-2 -->
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force mg-md-l--1">
                    <label class="form-control-label"> Merek <span class="tx-danger">*</span></label>
                    <input class="form-control" type="text" name="merek[]" placeholder="Enter Merek" required>
                  </div>
                </div><!-- col-3 -->
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force mg-md-l--1">
                    <label class="form-control-label"> NUP <span class="tx-danger">*</span></label>
                    <input class="form-control" type="text" name="nup[]" placeholder="Enter NUP" required>
                  </div>
                </div><!-- col-3 -->
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force mg-md-l--1">
                    <label class="form-control-label"> Jumlah <span class="tx-danger">*</span></label>
                    <input class="form-control" type="number" name="jumlah[]" placeholder="Enter Jumlah" required>
                  </div>
                </div><!-- col-2 -->
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force mg-md-l--1">
