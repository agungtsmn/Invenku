...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Management Peminjaman BMN</h4>
        <p class="mg-b-0">Menambah, Mengedit, dan Menghapus Data Peminjaman BMN</p>
      </div>
      <a href="/manage/peminjamanBmn/create" class="btn btn-teal btn-create">Create Data <i class="bi bi-plus"></i></a>
    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex flex-column justify-content-center align-items-center">
                      <a href="/manage/peminjamanBmn/{{ $peminjamanBmn->id }}/edit" class="btn btn-warning tx-10 pd-x-15 pd-y-5 mb-2"><i class="bi bi-pen mr-1"></i> Edit</a>
                      <div data-kode="{{ $peminjamanBmn->id }}" class="btn btn-danger tx-10 pd-x-10 pd-y-5 swal-confirm">
                        <form action="/manage/peminjamanBmn/{{ $peminjamanBmn->id }}" id="delete{{ $peminjamanBmn->id }}" method="post">
                            @csrf
                            @method('delete')
                        </form>
