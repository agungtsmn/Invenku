  ...
  <div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href="/manage/pegawai">Pegawai</a>
        <span class="breadcrumb-item active">Edit</span>
      </nav>
    </div><!-- br-pageheader -->
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Edit Pegawai</h4>
      <p class="mg-b-0">Edit pegawai in the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form class="form-layout form-layout-2" action="/manage/pegawai/{{ $pegawai->id }}" method="POST">
          @csrf
          @method('put')
          <div class="row no-gutters">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="nip" placeholder="Enter NIP" required value="{{ $pegawai->nip }}">
                @error('nip')  
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="text" name="nama" placeholder="Enter Nama" required value="{{ $pegawai->nama }}">
                @error('nama')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                <label class="form-control-label mg-b-0-force">Jabatan <span class="tx-danger">*</span></label>
                <select class="form-control select2-show-search" name="jabatan_id" data-placeholder="Pilih Jabatan" required>
          ...
          <div class="form-layout-footer bd pd-20 bd-t-0">
            ...
            <a href="/manage/pegawai" class="btn btn-secondary">Cancel</a href="">
          </div><!-- form-group -->
        </form><!-- form-layout -->
