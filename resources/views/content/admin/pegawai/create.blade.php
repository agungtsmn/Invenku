...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Create Pegawai</h4>
      <p class="mg-b-0">Adding pegawai to the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form class="form-layout form-layout-2" action="/manage/pegawai" method="post">
          @csrf
          <div class="row no-gutters">
            <div class="col-md-12">
              <div class="form-group">
                <label class="form-control-label">NIP <span class="tx-danger">*</span></label>
                <input class="form-control" type="number" name="nip" placeholder="Enter NIP" required value="{{ old('nip') }}">
                @error('nip')  
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="text" name="nama" placeholder="Enter Nama" required value="{{ old('nama') }}">
                @error('nama')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
          ...
          <div class="form-layout-footer bd pd-20 bd-t-0">
            ...
            <a href="/manage/pegawai" class="btn btn-secondary">Cancel</a>
          </div><!-- form-group -->
        </form><!-- form-layout -->
