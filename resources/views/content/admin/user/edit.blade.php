...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      ...
      <p class="mg-b-0">Edit user in the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form class="form-layout form-layout-2" action="/manage/user/{{ $user->id }}" method="POST">
          @csrf
          @method('put')
          <div class="row no-gutters">
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1">
                ...
                <input class="form-control" type="email" name="email" placeholder="Enter Email" required value="{{ $user->email }}">
                @error('email')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
