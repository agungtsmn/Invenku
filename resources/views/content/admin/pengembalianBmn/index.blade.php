  ...
  <div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href="/manage/pengembalianBmn">Manage</a>
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Management Pengembalian BMN</h4>
        <p class="mg-b-0">Menambah, Mengedit, dan Menghapus Data Pengembalian BMN</p>
      </div>
    </div>
                        ...
                        <div class="modal-dialog modal-sm w-100" role="document">
                          <div class="modal-content bd-0 tx-14">
                            ...
                            <div class="modal-body pd-20">
                              ...
                              <hr>
                              <span class="tx-12 tx-teal">Catatan : </span> <br>
                              {{ $peminjamanBmn->pengembalianBmn->catatan }} <br>
                            </div>
                            <div class="modal-footer justify-content-end">
                              <button type="button"
                                class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"
                ...
                <form id="accept{{ $peminjamanBmn->id }}" action="/manage/pengembalianBmn" method="POST"
                  ...
                  <div class="modal-body pd-20">
                    ...
                    <div class="form-group">
                      <label class="form-control-label">Catatan <span class="tx-danger">*</span></label>
...
@push('js')
  ...
  <script>
    $(".accepted-confirm").click(function(e) {
      ...
      if (id) {
        let form = document.getElementById('accept' + id);

        // cek validasi bawaan HTML5
        if (!form.checkValidity()) {
          form.reportValidity(); // tampilkan pesan warning bawaan browser
          return; // hentikan proses
        }

        // kalau valid, baru tampilkan konfirmasi Swal
        Swal.fire({
          title: 'Anda yakin ingin mensubmit?',
          icon: 'question',
