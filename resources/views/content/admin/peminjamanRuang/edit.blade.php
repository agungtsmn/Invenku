...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Edit Peminjaman Ruang</h4>
      <p class="mg-b-0">Edit peminjaman ruang in the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/manage/peminjamanRuang/{{ $peminjamanRuang->id }}" method="post">
          @csrf
          @method('put')
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <select class="form-control select2-show-search" name="status" data-placeholder="Pilih Status" required>
                  <option value="{{ $peminjamanRuang->status }}">{{ $peminjamanRuang->status }}</option>
