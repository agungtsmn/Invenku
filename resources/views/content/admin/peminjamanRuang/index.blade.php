...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Management Peminjaman Ruang</h4>
        <p class="mg-b-0">Menambah, Mengedit, dan Menghapus Data Peminjaman Ruang</p>
      </div>
      <a href="/manage/peminjamanRuang/create" class="btn btn-teal btn-create">Create Data <i class="bi bi-plus"></i></a>
    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="mb-1">
                      ...
                      @endif
                      <a target="_blank" href="/peminjamanRuang/{{ $peminjamanRuang->id }}/pdf" class="px-2 py-1 tx-12 bg-info text-light rounded"><i class="bi bi-filetype-pdf"></i> Pdf</a>
                    </div>
                  ...
                  <td>
                    <div class="d-flex flex-column justify-content-center align-items-center">
                      <a href="/manage/peminjamanRuang/{{ $peminjamanRuang->id }}/edit" class="btn btn-warning tx-10 pd-x-15 pd-y-5 mb-2"><i class="bi bi-pen mr-1"></i> Edit</a>
                      <div data-kode="{{ $peminjamanRuang->id }}" class="btn btn-danger tx-10 pd-x-10 pd-y-5 swal-confirm">
                        <form action="/manage/peminjamanRuang/{{ $peminjamanRuang->id }}" id="delete{{ $peminjamanRuang->id }}" method="post">
                            @csrf
                            @method('delete')
                        </form>
