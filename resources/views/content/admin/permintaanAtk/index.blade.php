...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Management Permintaan ATK / Suvenir</h4>
        <p class="mg-b-0">Menambah, Mengedit, dan Menghapus Data Permintaan ATK / Suvenir</p>
      </div>
      <a href="/manage/permintaanAtk/create" class="btn btn-teal btn-create">Create Data <i class="bi bi-plus"></i></a>
    </div>
          ...
          <table id="datatable1" class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-20p">ATK / Suvenir</th>
              ...
              @foreach ($permintaanAtks as $permintaanAtk)
                <tr>
                  ...
                  <td>
                    ...
                    <span class="tx-12">{{ $permintaanAtk->fPetugas->pegawai->nama ?? '-' }}</span>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="mb-1">
                      ...
                      @endif
                      <a target="_blank" href="/permintaanAtk/{{ $permintaanAtk->id }}/pdf" class="px-2 py-1 tx-12 bg-info text-light rounded"><i class="bi bi-filetype-pdf"></i> Pdf</a>
                    </div>
                  ...
                  <td>
                    <div class="d-flex justify-content-center">
                      <a href="/manage/permintaanAtk/{{ $permintaanAtk->id }}/edit" class="btn btn-warning tx-10 pd-x-10 pd-y-5 mr-2"><i class="bi bi-pen mr-1"></i> Edit</a>
                      <div data-kode="{{ $permintaanAtk->id }}" class="btn btn-danger tx-10 pd-x-10 pd-y-5 swal-confirm">
                        <form action="/manage/permintaanAtk/{{ $permintaanAtk->id }}" id="delete{{ $permintaanAtk->id }}" method="post">
                            @csrf
                            @method('delete')
                        </form>
