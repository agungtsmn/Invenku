...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Create Permintaan ATK / Suvenir</h4>
      <p class="mg-b-0">Adding permintaan ATK / Suvenir to the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/manage/permintaanAtk" method="post">
          @csrf
          <div class="row no-gutters">
            ...
            <div class="col-md-6">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="date" name="tanggal" placeholder="Enter Tanggal" required value="{{ old('tanggal') }}">
                @error('tanggal')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <input class="form-control" type="text" name="lokasi" placeholder="Enter Lokasi" required value="{{ old('lokasi') }}">
                @error('lokasi')  
                  <span style="color: #ed5646; font-size: 12px">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="row no-gutters row-atk"> <!-- Row ATK -->
                <div class="col-md-3">
                  <div class="form-group bd-t-0-force">
                    ...
                    <input class="form-control" type="text" name="nama[]" placeholder="Enter Nama ATK / Suvenir" required>
                  </div>
                </div><!-- col-3 -->
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                  <div class="form-group bd-t-0-force mg-md-l--1">
                    ...
                    <input class="form-control" type="text" name="spesifikasi[]" placeholder="Enter Spesifikasi" required>
                  </div>
                </div><!-- col-3 -->
                <div class="col-md-2">
