...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Management Jabatan</h4>
        <p class="mg-b-0">Menambah, Mengedit, dan Menghapus Data Jabatan</p>
      </div>
      <a href="/manage/jabatan/create" class="btn btn-teal btn-create">Create Data <i class="bi bi-plus"></i></a>
    </div>
          ...
          <table id="datatable1" class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-20p">Nama Jabatan</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center">
                      <a href="/manage/jabatan/{{ $jabatan->id }}/edit" class="btn btn-warning tx-10 pd-x-10 pd-y-5 mr-2"><i class="bi bi-pen mr-1"></i> Edit</a>
                      <div data-kode="{{ $jabatan->id }}" class="btn btn-danger tx-10 pd-x-10 pd-y-5 swal-confirm">
                        <form action="/manage/jabatan/{{ $jabatan->id }}" id="delete{{ $jabatan->id }}" method="post">
                            @csrf
                            @method('delete')
                        </form>
