...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Edit Jabatan</h4>
      <p class="mg-b-0">Edit jabatan in the database</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form class="form-layout form-layout-2" action="/manage/jabatan/{{ $jabatan->id }}" method="POST">
          @csrf
          @method('put')
          <div class="row no-gutters">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_jabatan" placeholder="Enter Nama Jabatan" required value="{{ $jabatan->nama_jabatan }}">
                @error('nama_jabatan')  
          ...
          <div class="form-layout-footer bd pd-20 bd-t-0">
            ...
            <a href="/manage/jabatan" class="btn btn-secondary">Cancel</a href="">
          </div><!-- form-group -->
        </form><!-- form-layout -->
