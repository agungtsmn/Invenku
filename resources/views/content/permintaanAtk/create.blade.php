...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Pengajuan Permintaan ATK / Suvenir</h4>
      <p class="mg-b-0">Form Pengajuan Permintaan ATK / Suvenir</p>
    </div>
          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-12" id="col-atk"> <!-- Col ATK -->
              <div class="row no-gutters row-atk"> <!-- Row ATK -->
                ...
                <div class="col-md-2">
                  <div class="form-group bd-t-0-force bd-l-0-force mg-md-r--1 text-center">
