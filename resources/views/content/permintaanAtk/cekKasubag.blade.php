  ...
  <div class="br-mainpanel">
    ...
    <div class="br-pagebody">
      <div class="br-section-wrapper">
        ...
        <form id="signature-form" class="form-layout form-layout-2" action="/permintaanAtk/{{ $permintaanAtk->id }}/accKasubag" method="post">
          @csrf
          @method('put')
          <div class="row no-gutters">
            ...
            <input type="hidden" name="status" value="Acc Kasubag">
