  ...
  <div class="br-mainpanel">
    ...
    <div class="br-pagebody">
      <div class="br-section-wrapper">
        ...
        <form class="form-layout form-layout-2" action="/permintaanAtk/{{ $permintaanAtk->id }}/accKatim" id="accept{{ $permintaanAtk->id }}" method="post">
          @csrf
          @method('put')
          <div class="row no-gutters">
            ...
            <input type="hidden" name="status" value="Acc Katim">
          ...
          <div class="form-layout-footer bd pd-20 bd-t-0">
            <button data-kode="{{ $permintaanAtk->id }}" type="button" class="btn btn-success tx-10 pd-x-10 pd-y-5 accepted-confirm"><i class="bi bi-patch-check-fill"></i> Accepted</button>
