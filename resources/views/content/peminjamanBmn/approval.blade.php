  ...
  <div class="br-mainpanel">
    ...
    <div class="br-pagebody">
      <div class="br-section-wrapper">
        ...
        <form id="signature-form" class="form-layout form-layout-2" action="/peminjamanBmn/{{ $peminjamanBmn->id }}/approved" method="post">
          @csrf
          @method('put')
            ...
            <div class="col-md-12" id="col-bmn"> <!-- Col BMN -->
              @foreach ($peminjamanBmn->bmn as $bmn)
                <div class="row no-gutters row-bmn"> <!-- Row BMN -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force">
                      <b class="tx-dark">{{ $bmn['jenis'] }}</b>
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force bd-l-0-force">
                      <b class="tx-dark">{{ $bmn['merek'] }}</b>
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force bd-l-0-force">
                      <b class="tx-dark">{{ $bmn['nup'] }}</b>
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force bd-l-0-force">
                      <b class="tx-dark">{{ $bmn['jumlah'] }}</b>
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force bd-l-0-force">
                      <b class="tx-dark">{{ $bmn['satuan'] }}</b>
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
            ...
            <div class="col-md-12">
              <div class="form-group bd-t-0-force mg-md-r--1">
                ...
                <div class="d-flex align-items-enter">
                  ...
                  <input type="hidden" name="signature_kasubag_tu" id="signature-kasubag-tu" required>
  ...
  <script>
    ...
    document.getElementById('signature-form').addEventListener('submit', function(e) {
      if (signaturePad.isEmpty()) {
        ...
        document.getElementById('signature-kasubag-tu').value = dataURL;
      }
    });
  </script>
