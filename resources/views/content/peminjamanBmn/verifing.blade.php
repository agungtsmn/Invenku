...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Verifikasi Pengajuan Peminjaman BMN</h4>
      <p class="mg-b-0">Memverifikasi Pengajuan Peminjaman BMN</p>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">

        <form id="signature-form" class="form-layout form-layout-2" action="/peminjamanBmn/{{ $peminjamanBmn->id }}/verifid" method="post">
          @csrf
          @method('put')
                ...
                <div class="row no-gutters row-bmn"> <!-- Row BMN -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force">
                      ...
                      <input class="form-control" type="text" name="jenis[{{ $loop->iteration - 1 }}]" placeholder="Enter Jenis BMN" required value="{{ $bmn['jenis'] }}">
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force mg-md-l--1">
                      <label class="form-control-label"> Merek <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="merek[{{ $loop->iteration - 1 }}]" placeholder="Enter Merek" required value="{{ $bmn['merek'] }}">
                    </div>
                  </div><!-- col-3 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force mg-md-l--1">
                      <label class="form-control-label"> NUP <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="nup[{{ $loop->iteration - 1 }}]" placeholder="Enter NUP" required value="{{ $bmn['nup'] }}">
                    </div>
                  </div><!-- col-3 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force mg-md-l--1">
                      <label class="form-control-label"> Jumlah <span class="tx-danger">*</span></label>
                      <input class="form-control" type="number" name="jumlah[{{ $loop->iteration - 1 }}]" placeholder="Enter Jumlah" required value="{{ $bmn['jumlah'] }}">
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
                    <div class="form-group bd-t-0-force mg-md-l--1">
                      <label class="form-control-label"> Satuan <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="satuan[{{ $loop->iteration - 1 }}]" placeholder="Enter Satuan" required value="{{ $bmn['satuan'] }}">
                    </div>
                  </div><!-- col-2 -->
                  <div class="col-md-2">
            ...
            <div class="col-md-12">
              <div class="form-group bd-t-0-force mg-md-r--1">
                ...
                <div class="d-flex align-items-enter">
                  ...
                  <input type="hidden" name="signature_verifikator" id="signature-verifikator" required>
  ...
  <script>
    ...
    document.getElementById('signature-form').addEventListener('submit', function(e) {
      if (signaturePad.isEmpty()) {
        ...
        document.getElementById('signature-verifikator').value = dataURL;
      }
    });
  </script>
