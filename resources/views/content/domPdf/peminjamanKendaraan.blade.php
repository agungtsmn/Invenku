...
<body>
  ...
  <section><br>
    <div class="text-center" tabindex="0">
      <p class="tx-16"><b>FORM PEMINJAMAN KENDARAAN</b></p>
    ...
    <table>
      ...
      <tr>
        ...
        <td class="colon">:</td>
        <td class="box">{{ $data->kendaraan->merek . " " . $data->kendaraan->nama}} | <b>{{ $data->kendaraan->no_polisi }}</b></td>
      </tr>
      <tr>
    ...
    <footer>
      ...
      <ul style="margin: 0; padding: 0 0 0 15px;">
        <li>Pak Edy - Kepala Pol Kendaraan</li>
        <li>Nisa - Resepsionis</li>
      </ul><br>
      <b>Peraturan peminjaman kendaraan:</b><br>
      <ul style="margin: 0; padding: 0 0 0 15px;">
        <li>Setelah disetujui, kunci dan STNK akan di berikan oleh petugas pemeliharaan kendaraan/resepsionis</li>
        <li>Kerusakan yang diakibatkan oleh kelalaian pemohon, sepenuhnya menjadi tanggung jawab pemohon</li>
      </ul>
    </footer>
  </section>
</body>
